...
export default new Modal({
  customId: 'modal_ticket_report:user',
  ...
  async execute(interaction: ModalSubmitInteraction, fields: ModalSubmitFields): Promise<void> {
    ...
    const reportedUser: string = fields.getTextInputValue('ticket_report_user:username');
    const subject: string = fields.getTextInputValue('ticket_report_user:subject');
    const description: string = fields.getTextInputValue('ticket_report_user:description');
